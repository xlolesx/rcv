  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <!-- Nav Item - Charts -->
        <li class="nav-item">
          <a class="nav-link" href="{{ route('index.policies') }}">
            <i class="fas fa-sticky-note"></i>
            <span>Pólizas</span></a>
          </li>

        <li class="nav-item">
          <a class="nav-link" href="{{ route('index.vehicles') }}">
            <i class="fas fa-car"></i>
            <span>Vehiculos</span></a>
          </li>

        <li class="nav-item">
          <a class="nav-link" href="{{ route('index.offices') }}">
            <i class="fas fa-building"></i>
            <span>Oficinas</span></a>
          </li>

        <li class="nav-item">
          <a class="nav-link" href="{{ route('index.prices') }}">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('index.payments') }}">
            <i class="fas fa-money-check-alt"></i>
            <span>Consultas de pago</span></a>
          </li>

        <li class="nav-item">
          <a class="nav-link" href="{{ route('admin.activity.log.all') }}">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Registro de Actividad</span></a>
          </li>
                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                      ...
                      <a class="dropdown-item" href="/admin/change-password/{{Auth::user()->id}}">
