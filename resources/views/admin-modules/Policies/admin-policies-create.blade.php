		...
		<form action="{{ route('register.policy.submit')}}" method="POST" id="form_policies">
			...
			<div class="form-row border-bottom border-dark">
				...
				<div class="form-group col-md-4">
					...
					<div class="input-group">
						<div class="input-group-prepend">				
							<select name="id_type" class="form-control custom-select is-invalid" id="id_type">
				...
				<div class="form-group col-md-4">                            
					...
					<div class="input-group">
						<div class="input-group-prepend">               
							<select name="sp_prefix" class="form-control custom-select is-invalid" id="number_code">
								<option value="">-</option>
			...
			<div class="form-row border-bottom border-dark">
				<div class="form-group col-md-6">
					...
					<select name="vehicleModel" class="form-control @error('vehicleModel') is-invalid @enderror is-invalid mt-2 mb-2 custom-select" id="model" >
					...
					<input autocomplete="off" type="text" name="type" id="type" class="form-control @error('type') is-invalid @enderror is-invalid" placeholder="..." >
