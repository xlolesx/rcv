...
<body>
  ...
  <table style="width:100%; margin-top: 12px;" class="vp-table">
    <caption><h1>Datos de de la póliza:</h1></caption>
    ...
    <tr style="text-align:center;">
      <td class="right-bd rid-bb"><strong>Total Cobertura: </strong>{{$policy->price->total_all}} Bs.S</td>
      <td class="rid-bb"><strong>Total Prima: </strong>{{$policy->price->total_premium}} Bs.S</td>
    </tr>
