...
<div class="card">
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
      <li class="nav-item">
        <a class="nav-link bg-dark active" href="/user/user-exportpdf/{{$policy->id}}">Exportar PDF</a>
      </li>

      <li class="nav-item">
        <a href="{{url()->previous()}}" class="nav-link bg-danger active ml-2">Volver</a>
      </li>
    </ul>
  </div>
   ...
   <div class="row border-bottom border-dark mb-4">
    ...
    <div class="row border-bottom border-dark mb-4">
      <div class="col-6 text-center border-right border-dark">
        ...
        @endif       
        <h6 class="mt-4"><span class="font-weight-bold mr-2">Total Cobertura: </span><span class="prices_se">{{$policy->price->total_all}}</span> Bs.S</h6>
      </div>
      <div class="col-6 text-center">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <form action="/user/renew-policy/{{$policy->id}}" method="POST">
                    @csrf
