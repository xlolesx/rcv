                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.register.vehicle.submit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="brand" type="text" class="form-control @error('brand') is-invalid @enderror is-invalid" name="brand" required autocomplete="brand" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="model" type="model" class="form-control @error('model') is-invalid @enderror is-invalid" name="model" required autocomplete="model">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="vehicleType" name="vehicleType" class="form-control custom-select is-invalid    " required>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('user.index.vehicles') }}" class="btn btn-danger" style="width: 90px;">
                                    Volver
                                </a>
                            </div>
                        </div>
