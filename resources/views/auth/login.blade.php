                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="{{ route('login') }}" autocomplete="off">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user w-75 m-auto" id="username" name="username" value="{{ old('username') }}" aria-describedby="emailHelp" placeholder="Nombre de Usuario" autocomplete="off" autofocus>
                    </div>
                    <div class="form-group">
